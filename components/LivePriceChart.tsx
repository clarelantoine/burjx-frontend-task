  ...
  return (
    <div className="bg-grey/30 flex flex-col gap-3 rounded-3xl border border-white/10 px-9 py-8">
      ...
      <div className="flex gap-4 px-3 text-xs text-white/50 capitalize">
        <p className="bg-green text-background rounded-md px-2.5 py-2 leading-none">
          1H
        </p>
        <p className="px-2.5 py-2 leading-none">1D</p>
        <p className="px-2.5 py-2 leading-none">1W</p>
        <p className="px-2.5 py-2 leading-none">1M</p>
        <p className="px-2.5 py-2 leading-none">1Y</p>
        <p className="px-2.5 py-2 leading-none">ALL</p>
      </div>
